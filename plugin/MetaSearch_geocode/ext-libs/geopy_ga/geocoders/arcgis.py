...
from geopy_ga.compat import urlencode, Request

from geopy_ga.geocoders.base import Geocoder, DEFAULT_SCHEME, DEFAULT_TIMEOUT, \
    DEFAULT_WKID
from geopy_ga.exc import GeocoderServiceError, GeocoderAuthenticationFailure
from geopy_ga.exc import ConfigurationError
...
class ArcGIS(Geocoder):  # pylint: disable=R0921,R0902,W0223
    ...
    def reverse(self, query, exactly_one=True, timeout=None, # pylint: disable=R0913,W0221
        ...
        """
        # ArcGIS is lon,lat; maintain lat,lon convention of geopy_ga
