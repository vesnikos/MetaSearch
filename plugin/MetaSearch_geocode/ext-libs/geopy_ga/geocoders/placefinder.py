...
from geopy_ga.geocoders.base import Geocoder, DEFAULT_TIMEOUT
from geopy_ga.exc import GeocoderParseError
from geopy_ga.location import Location
from geopy_ga.compat import string_compare, py3k
    ...
    def __init__(
        ...
        if requests_missing:
            raise ImportError(
                ...
                ' Install with `pip install geopy_ga -e ".[placefinder]"`.'
            )
