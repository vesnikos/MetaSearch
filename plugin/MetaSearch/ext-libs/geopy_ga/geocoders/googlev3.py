...
import hashlib
import hmac
from geopy_ga.compat import urlencode
from geopy_ga.geocoders.base import Geocoder, DEFAULT_TIMEOUT, DEFAULT_SCHEME
from geopy_ga.exc import (
    GeocoderQueryError,
...
from geopy_ga.location import Location
from geopy_ga.util import logger
...
class GoogleV3(Geocoder):  # pylint: disable=R0902
    ...
    def geocode(
        ...
        :param int timeout: Time, in seconds, to wait for the geocoding service
            to respond before raising a :class:`geopy_ga.exc.GeocoderTimedOut`
    ...
    def reverse(
        ...
        :type query: :class:`geopy_ga.point.Point`, list or tuple of (latitude,
    ...
    def timezone(self, location, at_time=None, timeout=None):
        ...
        **This is an unstable API.**
        ...
        :type location: :class:`geopy_ga.point.Point`, list or tuple of (latitude,
            longitude), or string as "%(latitude)s, %(longitude)s"
        ...
        if not pytz_available:
            raise ImportError(
                ...
                u' Install with `pip install geopy_ga -e ".[timezone]"`.'
            )
        ...
        try:
            ...
            raise GeocoderParseError(
                u"geopy_ga could not find a timezone in this response: %s" %
                response
            )
        return tz
